...
const ManagerAccount1 = () => {
  ...
  useEffect(() => {
    ...
    fetch(`http://127.0.0.1:8000/manager/profile?employee_id=${employeeId}`)
      .then((res) => {
  ...
  return (
    <div>
      <h1 style={{ textAlign: 'center', color: '#f28500', fontSize: '50px' }}>Trang tài khoản Manager</h1>
      <Account profile={profile} onConfirm={handleUpdate} />
    </div>
  );
};

export default ManagerAccount1;
